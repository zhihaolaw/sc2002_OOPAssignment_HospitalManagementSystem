...
public class HospitalManagementSystem_Main {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (values.length == 8) {
                    ...
                    switch (role) {
                        case "Doctor":
                            staffList.add(new Doctor(hospitalID, name, role, gender, age,contactNumber ,password, email));
                            break;
                        case "Pharmacist":
                            staffList.add(new Pharmacist(hospitalID, name, role, gender, age,contactNumber ,password, email));
                            break;
                        case "Administrator":
                            staffList.add(new Administrator(hospitalID, name, role, gender, age,contactNumber ,password, email));
                            break;
                        default:
 ...
 // Display the menu based on the user's role
    ...
    public static void saveStaffToFile() {
        ...
        CSV_Handler.saveToCSV(STAFF_LIST_FILE_PATH, staffData, "HospitalID,Name,Role,Gender,Age,ContactNumber,Password,Email");
    }
